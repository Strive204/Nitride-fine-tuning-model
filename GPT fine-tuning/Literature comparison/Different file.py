...
fine_tuned_model_id = "ft:gpt-3.5-turbo-0125:personal:samantha-test:Ao2DLwOf"
...
validation_files = [
    ('high_loss_training_data1.jsonl', ['FineTuned']),
    ('high_loss_training_data2.jsonl', ['GPT3.5', 'GPT4'])
]
...
def process_validation_set():
    try:
        for validation_file, models in validation_files:
            if not os.path.isfile(validation_file):
                print(f"Input file does not exist: {validation_file}")
                continue
